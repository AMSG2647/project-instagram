...
CREATE TABLE IF NOT EXISTS comments (
    ...
    CONSTRAINT fk_image_comment FOREIGN KEY (image_id) REFERENCES images(id)
...
CREATE TABLE IF NOT EXISTS likes (
    ...
    CONSTRAINT fk_image_like FOREIGN KEY (image_id) REFERENCES images(id)
...
-- INSERT INTO seguidores VALUES(NULL, 1, CURTIME(), CURTIME());
-- INSERT INTO seguidores VALUES(NULL, 2, CURTIME(), CURTIME());
-- INSERT INTO seguidores VALUES(NULL, 4, CURTIME(), CURTIME());

 -- CREATE TABLE IF NOT EXISTS user_seg{
 --     id int auto_increment not null, 
 --     seguidor_id int(255),
 --     created_at  datetime,
 --     updated_at  datatime,
 --     CONSTRAINT pk_user_seg PRIMARY KEY (id),
 --     CONSTRAINT fk_user FOREIGN KEY (user_id) REFERENCES users(id),
 --     CONSTRAINT fk_seguidor FOREIGN KEY (seguidor_id) REFERENCES seguidores(id)
 -- }
