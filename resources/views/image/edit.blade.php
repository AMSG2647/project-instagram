                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('image.update') }}" method="POST" enctype="multipart/form-data">                           
                            ...
                            <div class="form-group row">                               
                                <label for="image_path" style="margin-right:10px" class="col-md-3 col-form-label text-md-right">Imagen:</label>                
                                    <div class="col-md-7">
                                        <div class="container-avatar">
                                            <img style="width:200px; height:200px;" src="{{  route('image.file', ['filename' => $image->image_path]) }}" class="avatar">
                                        </div>
                                    </div>
                            </div>
